...
log using correction_stationary, replace
...
save temp/VAR_CAD_correction_stationary, replace
...
save temp/VAR_CHF_correction_stationary, replace
...
save temp/VAR_DEM_correction_stationary, replace
...
save temp/VAR_FRF_correction_stationary, replace
...
save temp/VAR_GBP_correction_stationary, replace
...
save temp/VAR_ITL_correction_stationary, replace
...
save temp/VAR_JPY_correction_stationary, replace
...
save temp/VAR_NOK_correction_stationary, replace
...
save temp/VAR_SEK_correction_stationary, replace
