...
replace p_t = `p_val'
outreg2 using "tables/s_t_12.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
replace p_ip = `p_val'
outreg2 using "tables/s_ip_12.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
outreg2 using "tables/s_diff_12.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
outreg2 using "tables/s_diff_shock_12.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_t')/`se'))
replace p_t = `p_val'
outreg2 using "tables/s_t_12.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_ip')/`se'))
replace p_ip = `p_val'
outreg2 using "tables/s_ip_12.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_diff')/`se'))
replace p_diff = `p_val'
outreg2 using "tables/s_diff_12.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_shock')/`se'))
replace p_shock = `p_val'
outreg2 using "tables/s_diff_shock_12.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
