...
** CAD
use temp/VAR_CAD_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
...
** CHF
use temp/VAR_CHF_correction_nonstationary.dta, clear
...
** DEM
use temp/VAR_DEM_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
...
** FRF
use temp/VAR_FRF_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
...
** GBP
use temp/VAR_GBP_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
...
** ITL
use temp/VAR_ITL_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
...
** JPY
use temp/VAR_JPY_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
...
** NOK
use temp/VAR_NOK_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
...
** SEK
use temp/VAR_SEK_correction_nonstationary.dta, clear
egen sd_t = sd(s_T)
gen var_t = sd_t * sd_t
egen sd_ip = sd(s_IP)
gen var_ip = sd_ip * sd_ip
