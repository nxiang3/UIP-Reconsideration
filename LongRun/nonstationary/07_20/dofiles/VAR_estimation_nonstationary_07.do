...
log using estimate_nonstationary_07_20, replace
...
save data/data_var_estimate_07_20.dta, replace


	** 2 "CAD" 
		* data available: 06/1979 (t=1) - 11/2017 (t=462)

		use data/data_var_estimate_07_20.dta, clear
		keep if country2 == "CAD"
		
		save temp/VAR_CAD_07_20.dta, replace
	...
	** 3 "CHF" 
		* data available: 01/1989 (t=116) - 02/2020 (t=489)
		...
		save temp/VAR_CHF_07_20.dta, replace
	...
	** 4 "DEM" 
		* data available: 06/1979 (t=1) - 02/2020 (t=489)
		...
		save temp/VAR_DEM_07_20.dta, replace
	...
	** 5 "FRF" 
		* data available: 06/1979 (t=1) - 02/2020 (t=489)
		...
		save temp/VAR_FRF_07_20.dta, replace
	...
	** 6 "GBP" 
		* data available: 06/1979 (t=1) - 02/2020 (t=489)
		...
		save temp/VAR_GBP_07_20.dta, replace
	...
	** 7 "ITL"
		* data available: 06/1979 (t=1) - 02/2020 (t=489)
		...
		save temp/VAR_ITL_07_20.dta, replace
	...
	** 8 "JPY" 
		* data available: 06/1979 (t=1) - 02/2020 (t=489)
		...
		save temp/VAR_JPY_07_20.dta, replace
	...
	** 9 "NOK" 
		* data available: 01/1986 (t=80) - 11/2017 (t=462)
		...
		save temp/VAR_NOK_07_20.dta, replace
	...
	** 11 "SEK"
		* data available: 01/1987 (t=92) - 11/2017 (t=462)
		...
		save temp/VAR_SEK_07_20.dta, replace
...
* CAD
clear matrix
use temp/VAR_CAD_07_20.dta, clear
sort year month
replace t = _n
xtset cty2 t
...
save temp/VAR_CAD_est_07_20.dta, replace
...
* CHF
clear matrix
use temp/VAR_CHF_07_20.dta, clear
...
save temp/VAR_CHF_est_07_20.dta, replace
...
* DEM
clear matrix
use temp/VAR_DEM_07_20.dta, clear
...
save temp/VAR_DEM_est_07_20.dta, replace
...
* FRF
clear matrix
use temp/VAR_FRF_07_20.dta, clear
...
save temp/VAR_FRF_est_07_20.dta, replace
...
* GBP
clear matrix
use temp/VAR_GBP_07_20.dta, clear
...
save temp/VAR_GBP_est_07_20.dta, replace
...
* ITL
clear matrix
use temp/VAR_ITL_07_20.dta, clear
...
save temp/VAR_ITL_est_07_20.dta, replace
...
* JPY
clear matrix
use temp/VAR_JPY_07_20.dta, clear
...
save temp/VAR_JPY_est_07_20.dta, replace
...
* NOK
clear matrix
use temp/VAR_NOK_07_20.dta, clear
...
save temp/VAR_NOK_est_07_20.dta, replace
...
* SEK
clear matrix
use temp/VAR_SEK_07_20.dta, clear
...
save temp/VAR_SEK_est_07_20.dta, replace
