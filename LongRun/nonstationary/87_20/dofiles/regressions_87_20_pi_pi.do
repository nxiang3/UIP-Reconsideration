...
*** by Nan Xiang
cd /Users/wangmengqi/Desktop/UW/Courses/Econ872/Secondpart/task210108/nonstationary/87_20

** CAD
use temp/VAR_CAD_correction_nonstationary_87_20, clear
...
replace p_t = `p_val'
outreg2 using "tables/s_t_pi_pi_87_20.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
replace p_ip = `p_val'
outreg2 using "tables/s_ip_pi_pi_87_20.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
outreg2 using "tables/s_diff_pi_pi_87_20.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
outreg2 using "tables/s_diff_shock_pi_pi_87_20.xls", replace dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')

** CHF
use temp/VAR_CHF_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
local p_val = 2*ttail(e(df_r), abs((`coef_t')/`se'))
replace p_t = `p_val'
outreg2 using "tables/s_t_pi_pi_87_20.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_ip')/`se'))
replace p_ip = `p_val'
outreg2 using "tables/s_ip_pi_pi_87_20.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_diff')/`se'))
replace p_diff = `p_val'
outreg2 using "tables/s_diff_pi_pi_87_20.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')
...
local p_val = 2*ttail(e(df_r), abs((`coef_shock')/`se'))
replace p_shock = `p_val'
outreg2 using "tables/s_diff_shock_pi_pi_87_20.xls", append dec(3) noaster stats(coef se) adds(t-test, `tstat', CI-low, `cilow', CI-high, `cihigh', p-val, `p_val')

** DEM
use temp/VAR_DEM_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
** FRF
use temp/VAR_FRF_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
** GBP
use temp/VAR_GBP_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
** ITL
use temp/VAR_ITL_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
** JPY
use temp/VAR_JPY_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
** NOK
use temp/VAR_NOK_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
...
** SEK
use temp/VAR_SEK_correction_nonstationary_87_20, clear
replace pi_r_yoy = pi_r_yoy * 12
gen pi_r_yoy_shock = d.pi_r_yoy
