...
foreach country in CAD CHF DEM FRF GBP ITL JPY NOK SEK{
	...
	* Residuals Prediction
	...
	replace pi_ryoy = pi_ryoy * 12
	gen pi_shock = d.pi_ryoy
	
	//newey s_T pi_ryoy, lag(3)
	//newey s_IP pi_ryoy, lag(3)
	newey s_diff pi_ryoy, lag(3)
	//newey s_diff_shock pi_shock, lag(3)
